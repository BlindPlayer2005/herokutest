...
exports.default = {
    ...
    callback: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var userId, duration, reason, user, time, type, split, expires, result, ignored_1;
            var _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        result = _c.sent();
                        if (result) {
                            return [2 /*return*/, "<@" + userId + "> is already banned in this server."];
                        }
                        _c.label = 4;
                    case 4:
                        _c.trys.push([4, 7, , 8]);
                        return [4 /*yield*/, guild.members.ban(userId, { reason: reason })];
                    case 5:
                        _c.sent();
                    ...
                    case 8: return [2 /*return*/, "<@" + userId + "> has been banned for \"" + duration + "\""];
                }
            });
        });
    },
